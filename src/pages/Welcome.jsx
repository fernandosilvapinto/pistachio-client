    ...
    <div>
      ...
      <section id="services" className="max-w-5xl mx-auto px-6 py-20">
        <div className="flex flex-col gap-3 mb-10">
          ...
          <p className="text-gray-500">{branding.servicesIntro}</p>
        </div>
      ...
      <section className="bg-gray-50 border-t border-gray-100">
        <div className="max-w-5xl mx-auto px-6 py-20 grid grid-cols-1 sm:grid-cols-3 gap-8">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-gray-400">{branding.addressLine1}<br />{branding.addressLine2}</p>
          </div>
          <div className="flex flex-col gap-2">
            <div className="w-10 h-10 rounded-lg bg-gray-900 flex items-center justify-center text-white">
              🕐
            ...
            <p className="text-sm text-gray-400">{branding.hoursWeekdays}<br />{branding.hoursWeekend}</p>
          </div>
          <div className="flex flex-col gap-2">
            <div className="w-10 h-10 rounded-lg bg-gray-900 flex items-center justify-center text-white">
              📞
            ...
            <p className="text-sm text-gray-400">{branding.phone}<br />{branding.email}</p>
          </div>
        </div>
      </section>
